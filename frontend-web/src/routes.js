...
// Assets
const BankAccounts = React.lazy(() => import('./views/assets/bankAccounts/BankAccounts'))
const Properties = React.lazy(() => import('./views/assets/properties/Properties'))
const Vehicles = React.lazy(() => import('./views/assets/vehicles/Vehicles'))

// Liabilities
const Institutional = React.lazy(() => import('./views/liabilities/institutional/Institutional'))
const Personal = React.lazy(() => import('./views/liabilities/personal/Personal'))

// Investments
const Deposits = React.lazy(() => import('./views/investments/deposits/Deposits'))
const Obligations = React.lazy(() => import('./views/investments/obligations/Obligations'))
const Gold = React.lazy(() => import('./views/investments/gold/Gold'))
const MutualFunds = React.lazy(() => import('./views/investments/mutualFunds/MutualFunds'))
const Stocks = React.lazy(() => import('./views/investments/stocks/Stocks'))
const P2pLending = React.lazy(() => import('./views/investments/p2pLending/P2pLending'))
